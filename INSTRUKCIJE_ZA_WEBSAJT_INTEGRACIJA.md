...
Povezati websajt `https://massage-booking-fix.preview.emergentagent.com/` sa booking sistemom `https://massage-booking-fix.preview.emergentagent.com/` da:
...
function MasazePage() {
  ...
  useEffect(() => {
    // Učitaj sve usluge
    fetch('https://massage-booking-fix.preview.emergentagent.com/api/services')
      .then(res => res.json())
      .then(data => {
