...
Povezati websajt `https://price-consistency.preview.emergentagent.com/` sa booking sistemom `https://price-consistency.preview.emergentagent.com/` da:
...
function MasazePage() {
  ...
  useEffect(() => {
    // Učitaj sve usluge
    fetch('https://price-consistency.preview.emergentagent.com/api/services')
      .then(res => res.json())
      .then(data => {
