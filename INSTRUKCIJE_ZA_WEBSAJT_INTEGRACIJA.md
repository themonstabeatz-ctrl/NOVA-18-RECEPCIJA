...
Povezati websajt `https://massage-scheduler-4.preview.emergentagent.com/` sa booking sistemom `https://massage-scheduler-4.preview.emergentagent.com/` da:
...
function MasazePage() {
  ...
  useEffect(() => {
    // Učitaj sve usluge
    fetch('https://massage-scheduler-4.preview.emergentagent.com/api/services')
      .then(res => res.json())
      .then(data => {
