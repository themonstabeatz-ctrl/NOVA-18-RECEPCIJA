...
Povezati websajt `https://therapy-booking-21.preview.emergentagent.com/` sa booking sistemom `https://therapy-booking-21.preview.emergentagent.com/` da:
...
function MasazePage() {
  ...
  useEffect(() => {
    // Učitaj sve usluge
    fetch('https://therapy-booking-21.preview.emergentagent.com/api/services')
      .then(res => res.json())
      .then(data => {
