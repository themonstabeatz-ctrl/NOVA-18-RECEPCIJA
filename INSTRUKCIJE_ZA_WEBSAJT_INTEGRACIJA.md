...
Povezati websajt `https://spa-booking-api.preview.emergentagent.com/` sa booking sistemom `https://spa-booking-api.preview.emergentagent.com/` da:
...
function MasazePage() {
  ...
  useEffect(() => {
    // Učitaj sve usluge
    fetch('https://spa-booking-api.preview.emergentagent.com/api/services')
      .then(res => res.json())
      .then(data => {
