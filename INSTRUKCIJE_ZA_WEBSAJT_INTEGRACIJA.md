...
Povezati websajt `https://spa-dashboard-2.preview.emergentagent.com/` sa booking sistemom `https://spa-dashboard-2.preview.emergentagent.com/` da:
...
function MasazePage() {
  ...
  useEffect(() => {
    // Učitaj sve usluge
    fetch('https://spa-dashboard-2.preview.emergentagent.com/api/services')
      .then(res => res.json())
      .then(data => {
