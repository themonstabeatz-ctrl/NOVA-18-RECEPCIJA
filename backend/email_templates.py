...
# NOTE: render_client_email removed - now using SHARED template from email_templates/client_shared.py
# Both SPA and MASSAGE use the same client email design (MASAŽE design)
