...
await fetch('https://multilingfix.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://multilingfix.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://multilingfix.preview.emergentagent.com/massage
...
**Backend URL:** https://multilingfix.preview.emergentagent.com/api
