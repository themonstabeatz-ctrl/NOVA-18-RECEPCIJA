...
```javascript
const response = await fetch('https://prices-snapshot.preview.emergentagent.com/api/services');
...
await fetch('https://prices-snapshot.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://prices-snapshot.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://prices-snapshot.preview.emergentagent.com/massage
...
**Backend URL:** https://prices-snapshot.preview.emergentagent.com/api
