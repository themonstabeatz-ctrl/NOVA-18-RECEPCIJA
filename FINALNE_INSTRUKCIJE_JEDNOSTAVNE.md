...
```javascript
const response = await fetch('https://backend-pricing.preview.emergentagent.com/api/services');
...
await fetch('https://backend-pricing.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://backend-pricing.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://backend-pricing.preview.emergentagent.com/massage
...
**Backend URL:** https://backend-pricing.preview.emergentagent.com/api
