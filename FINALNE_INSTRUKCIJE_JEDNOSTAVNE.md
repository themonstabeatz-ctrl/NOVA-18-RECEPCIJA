...
```javascript
const response = await fetch('https://price-consistency.preview.emergentagent.com/api/services');
...
await fetch('https://price-consistency.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://price-consistency.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://price-consistency.preview.emergentagent.com/massage
...
**Backend URL:** https://price-consistency.preview.emergentagent.com/api
