...
```javascript
const response = await fetch('https://therapy-booking-21.preview.emergentagent.com/api/services');
...
await fetch('https://therapy-booking-21.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://therapy-booking-21.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://therapy-booking-21.preview.emergentagent.com/massage
...
**Backend URL:** https://therapy-booking-21.preview.emergentagent.com/api
