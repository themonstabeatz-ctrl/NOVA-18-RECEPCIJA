...
await fetch('https://discount-system-fix.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://discount-system-fix.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://discount-system-fix.preview.emergentagent.com/massage
...
**Backend URL:** https://discount-system-fix.preview.emergentagent.com/api
