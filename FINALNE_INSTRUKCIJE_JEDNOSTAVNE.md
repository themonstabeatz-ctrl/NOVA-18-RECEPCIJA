...
```javascript
const response = await fetch('https://discount-fixer.preview.emergentagent.com/api/services');
...
await fetch('https://discount-fixer.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://discount-fixer.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://couples-discount-fix.preview.emergentagent.com/massage
...
**Backend URL:** https://discount-fixer.preview.emergentagent.com/api
