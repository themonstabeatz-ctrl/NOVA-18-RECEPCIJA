...
await fetch('https://price-analyzer-8.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://price-analyzer-8.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://price-analyzer-8.preview.emergentagent.com/massage
...
**Backend URL:** https://price-analyzer-8.preview.emergentagent.com/api
