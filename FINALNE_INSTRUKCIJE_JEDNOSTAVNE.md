...
```javascript
const response = await fetch('https://therapist-scheduler.preview.emergentagent.com/api/services');
...
await fetch('https://therapist-scheduler.preview.emergentagent.com/api/appointments/couple', {
  method: 'POST',
...
```javascript
// 1. Fetch
const services = await fetch('https://therapist-scheduler.preview.emergentagent.com/api/services').then(r => r.json());
...
// Otvori: https://therapist-scheduler.preview.emergentagent.com/massage
...
**Backend URL:** https://therapist-scheduler.preview.emergentagent.com/api
