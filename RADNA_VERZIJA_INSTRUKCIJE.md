...
**Backend je IDENTIČAN kao na: https://spa-dashboard-2.preview.emergentagent.com/**
...
```javascript
const services = await fetch('https://spa-dashboard-2.preview.emergentagent.com/api/services')
  .then(r => r.json());
