...
**Backend je IDENTIČAN kao na: https://multilingfix.preview.emergentagent.com/**
...
```javascript
const services = await fetch('https://multilingfix.preview.emergentagent.com/api/services')
  .then(r => r.json());
