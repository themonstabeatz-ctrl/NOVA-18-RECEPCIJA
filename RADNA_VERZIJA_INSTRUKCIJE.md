...
**Backend je IDENTIČAN kao na: https://price-consistency.preview.emergentagent.com/**
...
```javascript
const services = await fetch('https://price-consistency.preview.emergentagent.com/api/services')
  .then(r => r.json());
