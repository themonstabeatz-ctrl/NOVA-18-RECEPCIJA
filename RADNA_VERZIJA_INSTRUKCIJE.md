...
**Backend je IDENTIČAN kao na: https://therapy-booking-21.preview.emergentagent.com/**
...
```javascript
const services = await fetch('https://therapy-booking-21.preview.emergentagent.com/api/services')
  .then(r => r.json());
