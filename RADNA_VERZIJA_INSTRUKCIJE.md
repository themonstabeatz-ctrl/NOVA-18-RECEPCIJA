...
**Backend je IDENTIČAN kao na: https://spa-booking-api.preview.emergentagent.com/**
...
```javascript
const services = await fetch('https://spa-booking-api.preview.emergentagent.com/api/services')
  .then(r => r.json());
