...
**Backend je IDENTIČAN kao na: https://discount-system-fix.preview.emergentagent.com/**
...
```javascript
const services = await fetch('https://discount-system-fix.preview.emergentagent.com/api/services')
  .then(r => r.json());
