...
```bash
curl -X GET "https://spa-booking-api.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://spa-booking-api.preview.emergentagent.com/api/services/single/list"
```
