...
```bash
curl -X GET "https://spa-dashboard-2.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://spa-dashboard-2.preview.emergentagent.com/api/services/single/list"
```
