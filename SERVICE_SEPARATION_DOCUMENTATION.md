...
```bash
curl -X GET "https://spa-integration.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://spa-integration.preview.emergentagent.com/api/services/single/list"
```
