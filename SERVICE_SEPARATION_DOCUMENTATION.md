...
```bash
curl -X GET "https://massage-scheduler-4.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://massage-scheduler-4.preview.emergentagent.com/api/services/single/list"
```
