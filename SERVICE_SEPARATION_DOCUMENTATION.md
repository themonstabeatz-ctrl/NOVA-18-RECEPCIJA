...
```bash
curl -X GET "https://price-analyzer-8.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://price-analyzer-8.preview.emergentagent.com/api/services/single/list"
```
