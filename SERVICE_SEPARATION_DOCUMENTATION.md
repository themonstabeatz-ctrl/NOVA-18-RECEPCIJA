...
```bash
curl -X GET "https://massage-booking-fix.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://massage-booking-fix.preview.emergentagent.com/api/services/single/list"
```
