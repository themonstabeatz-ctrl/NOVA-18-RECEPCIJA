...
```bash
curl -X GET "https://spa-web-update.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://spa-web-update.preview.emergentagent.com/api/services/single/list"
```
