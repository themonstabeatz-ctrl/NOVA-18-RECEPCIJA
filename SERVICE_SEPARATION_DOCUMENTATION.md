...
```bash
curl -X GET "https://prices-snapshot.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://prices-snapshot.preview.emergentagent.com/api/services/single/list"
```
