...
```bash
curl -X GET "https://discount-system-fix.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://discount-system-fix.preview.emergentagent.com/api/services/single/list"
```
