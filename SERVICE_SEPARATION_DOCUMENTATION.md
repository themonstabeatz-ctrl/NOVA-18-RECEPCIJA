...
```bash
curl -X GET "https://therapist-scheduler.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://therapist-scheduler.preview.emergentagent.com/api/services/single/list"
```
