...
```bash
curl -X GET "https://therapy-booking-21.preview.emergentagent.com/api/services/couples/list"
```
...
```bash
curl -X GET "https://therapy-booking-21.preview.emergentagent.com/api/services/single/list"
```
