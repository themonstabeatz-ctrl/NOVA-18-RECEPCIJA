...
```javascript
// Fetch SVE servise
const services = await fetch('https://massage-scheduler-4.preview.emergentagent.com/api/services')
  .then(r => r.json());
...
const allServices = await fetch('https://massage-scheduler-4.preview.emergentagent.com/api/services')
  .then(r => r.json());
