...
```javascript
// Fetch SVE servise
const services = await fetch('https://prices-snapshot.preview.emergentagent.com/api/services')
  .then(r => r.json());
...
const allServices = await fetch('https://prices-snapshot.preview.emergentagent.com/api/services')
  .then(r => r.json());
