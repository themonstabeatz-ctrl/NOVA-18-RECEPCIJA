...
```javascript
// Fetch SVE servise
const services = await fetch('https://spa-web-update.preview.emergentagent.com/api/services')
  .then(r => r.json());
...
const allServices = await fetch('https://spa-web-update.preview.emergentagent.com/api/services')
  .then(r => r.json());
