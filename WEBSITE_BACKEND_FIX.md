...
## Problem
Website `https://discount-system-fix.preview.emergentagent.com/` ne može da se poveže sa backend-om.
...
```bash
# STARO (ne radi):
REACT_APP_BACKEND_URL=https://discount-system-fix.preview.emergentagent.com/api
...
Test URL:
```
https://discount-system-fix.preview.emergentagent.com/api/services/single/list
```
...
```javascript
const API_BASE_URL = "https://discount-system-fix.preview.emergentagent.com/api";
```
