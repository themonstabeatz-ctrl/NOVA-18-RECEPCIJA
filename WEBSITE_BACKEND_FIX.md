...
## Problem
Website `https://therapy-booking-21.preview.emergentagent.com/` ne može da se poveže sa backend-om.

## Rešenje
Backend JE AKTIVAN i radi na:
```
https://therapy-booking-21.preview.emergentagent.com/api
```
...
```bash
# STARO (ne radi):
REACT_APP_BACKEND_URL=https://therapy-booking-21.preview.emergentagent.com/api
...
Test URL:
```
https://therapy-booking-21.preview.emergentagent.com/api/services/single/list
```
...
```javascript
const API_BASE_URL = "https://therapy-booking-21.preview.emergentagent.com/api";
```
