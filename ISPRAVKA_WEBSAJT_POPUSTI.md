...
**Treba da poziva:**
```
https://discount-system-fix.preview.emergentagent.com/api/services  ✅ (preview)
```
...
const BOOKING_API = process.env.REACT_APP_BOOKING_API || 'https://discount-system-fix.preview.emergentagent.com/api';
```
...
1. **Postavi popust u booking sistemu:**
   - Idi na: https://discount-system-fix.preview.emergentagent.com/services
