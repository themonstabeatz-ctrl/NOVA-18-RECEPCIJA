...
**Treba da poziva:**
```
https://therapist-scheduler.preview.emergentagent.com/api/services  ✅ (preview)
```
...
const BOOKING_API = process.env.REACT_APP_BOOKING_API || 'https://therapist-scheduler.preview.emergentagent.com/api';
```
...
1. **Postavi popust u booking sistemu:**
   - Idi na: https://therapist-scheduler.preview.emergentagent.com/services
