...
**Treba da poziva:**
```
https://massage-booking-fix.preview.emergentagent.com/api/services  ✅ (preview)
```
...
const BOOKING_API = process.env.REACT_APP_BOOKING_API || 'https://massage-booking-fix.preview.emergentagent.com/api';
```
...
1. **Postavi popust u booking sistemu:**
   - Idi na: https://massage-booking-fix.preview.emergentagent.com/services
