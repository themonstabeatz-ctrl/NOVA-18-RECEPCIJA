...
**Treba da poziva:**
```
https://backend-pricing.preview.emergentagent.com/api/services  ✅ (preview)
```
...
const BOOKING_API = process.env.REACT_APP_BOOKING_API || 'https://backend-pricing.preview.emergentagent.com/api';
```
...
1. **Postavi popust u booking sistemu:**
   - Idi na: https://backend-pricing.preview.emergentagent.com/services
