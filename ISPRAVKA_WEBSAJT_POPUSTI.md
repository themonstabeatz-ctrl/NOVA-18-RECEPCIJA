...
**Treba da poziva:**
```
https://therapy-booking-21.preview.emergentagent.com/api/services  ✅ (preview)
```
...
const BOOKING_API = process.env.REACT_APP_BOOKING_API || 'https://therapy-booking-21.preview.emergentagent.com/api';
```
...
1. **Postavi popust u booking sistemu:**
   - Idi na: https://therapy-booking-21.preview.emergentagent.com/services
