            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider sticky right-0 bg-gray-50 shadow-sm whitespace-nowrap" style={{minWidth: '160px'}}>
                    Akcije
                  </th>
                </tr>
              </thead>
                ...
                {appointments.length === 0 ? (
                  ...
                  appointments.map((appointment) => (
                    <tr key={appointment.id} data-testid={`appointment-row-${appointment.id}`}>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap" style={{minWidth: '90px'}}>
                        <span
                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium sticky right-0 bg-white shadow-sm" style={{minWidth: '160px'}}>
