...
- **URL:** `https://spa-dashboard-2.preview.emergentagent.com/api/services`
...
```bash
curl https://spa-dashboard-2.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://spa-dashboard-2.preview.emergentagent.com/services
