...
- **URL:** `https://therapy-booking-21.preview.emergentagent.com/api/services`
...
```bash
curl https://therapy-booking-21.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://therapy-booking-21.preview.emergentagent.com/services
