...
- **URL:** `https://therapist-scheduler.preview.emergentagent.com/api/services`
...
```bash
curl https://therapist-scheduler.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://therapist-scheduler.preview.emergentagent.com/services
