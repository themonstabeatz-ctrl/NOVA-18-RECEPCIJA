...
- **URL:** `https://spa-integration.preview.emergentagent.com/api/services`
...
```bash
curl https://spa-integration.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://spa-integration.preview.emergentagent.com/services
