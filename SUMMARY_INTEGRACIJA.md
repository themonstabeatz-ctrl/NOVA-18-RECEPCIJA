...
- **URL:** `https://spa-booking-api.preview.emergentagent.com/api/services`
...
```bash
curl https://spa-booking-api.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://spa-booking-api.preview.emergentagent.com/services
