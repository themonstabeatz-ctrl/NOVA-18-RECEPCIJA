...
- **URL:** `https://massage-scheduler-4.preview.emergentagent.com/api/services`
...
```bash
curl https://massage-scheduler-4.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://massage-scheduler-4.preview.emergentagent.com/services
