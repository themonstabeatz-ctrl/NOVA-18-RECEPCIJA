...
- **URL:** `https://multilingfix.preview.emergentagent.com/api/services`
...
```bash
curl https://multilingfix.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://multilingfix.preview.emergentagent.com/services
