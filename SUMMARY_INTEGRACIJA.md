...
- **URL:** `https://relax-booking-3.preview.emergentagent.com/api/services`
...
```bash
curl https://relax-booking-3.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://relax-booking-3.preview.emergentagent.com/services
