...
- **URL:** `https://spabooking.preview.emergentagent.com/api/services`
...
```bash
curl https://spabooking.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://spabooking.preview.emergentagent.com/services
2. Klikni na "Kartica Masaza za parove"
3. Klikni na sliku za -15% popust
4. Potvrdi

### Test 3: Proveri websajt
1. Idi na: https://buluang-spa-fix.preview.emergentagent.com/
2. Refresh page
