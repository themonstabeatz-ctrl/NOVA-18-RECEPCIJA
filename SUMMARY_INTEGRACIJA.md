...
- **URL:** `https://price-consistency.preview.emergentagent.com/api/services`
...
```bash
curl https://price-consistency.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://price-consistency.preview.emergentagent.com/services
