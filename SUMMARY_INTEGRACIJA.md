...
- **URL:** `https://spa-web-update.preview.emergentagent.com/api/services`
...
```bash
curl https://spa-web-update.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://spa-web-update.preview.emergentagent.com/services
