...
- **URL:** `https://massage-booking-fix.preview.emergentagent.com/api/services`
...
```bash
curl https://massage-booking-fix.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://massage-booking-fix.preview.emergentagent.com/services
