...
- **URL:** `https://price-analyzer-8.preview.emergentagent.com/api/services`
...
```bash
curl https://price-analyzer-8.preview.emergentagent.com/api/services | jq
```

### Test 2: Postavi popust u booking sistemu
1. Idi na: https://price-analyzer-8.preview.emergentagent.com/services
