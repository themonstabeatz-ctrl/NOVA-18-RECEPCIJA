...
```bash
curl -X POST https://discount-fixer.preview.emergentagent.com/api/appointments/couple \
...
6. Kada korisnik submituje, pošalji na:
   POST https://discount-fixer.preview.emergentagent.com/api/appointments/couple
