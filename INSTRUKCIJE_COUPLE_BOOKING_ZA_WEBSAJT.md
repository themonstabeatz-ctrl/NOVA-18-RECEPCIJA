...
```bash
curl -X POST https://therapist-booking-2.preview.emergentagent.com/api/appointments/couple \
...
6. Kada korisnik submituje, pošalji na:
   POST https://therapist-booking-2.preview.emergentagent.com/api/appointments/couple
