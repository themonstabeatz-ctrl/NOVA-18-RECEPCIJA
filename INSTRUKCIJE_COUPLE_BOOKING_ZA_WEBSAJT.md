...
**URL:** `https://therapist-scheduler.preview.emergentagent.com/api/appointments/couple`
...
```bash
curl -X POST https://therapist-scheduler.preview.emergentagent.com/api/appointments/couple \
...
6. Kada korisnik submituje, pošalji na:
   POST https://therapist-scheduler.preview.emergentagent.com/api/appointments/couple
