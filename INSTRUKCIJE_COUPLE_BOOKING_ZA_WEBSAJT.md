...
```bash
curl -X POST https://relax-booking-3.preview.emergentagent.com/api/appointments/couple \
...
6. Kada korisnik submituje, pošalji na:
   POST https://relax-booking-3.preview.emergentagent.com/api/appointments/couple
