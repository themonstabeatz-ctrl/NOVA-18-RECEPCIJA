...
**URL:** `https://backend-pricing.preview.emergentagent.com/api/appointments/couple`
...
```bash
curl -X POST https://backend-pricing.preview.emergentagent.com/api/appointments/couple \
...
6. Kada korisnik submituje, pošalji na:
   POST https://backend-pricing.preview.emergentagent.com/api/appointments/couple
