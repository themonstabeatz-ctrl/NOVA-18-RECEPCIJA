...
- **URL:** https://spabooking.preview.emergentagent.com/
...
### Websajt (Preview)
- **URL:** https://buluang-spa-fix.preview.emergentagent.com/
...
- [ ] Promeni API URL u `https://spabooking.preview.emergentagent.com/api`
...
### Test 1: Popusti
1. Otvori booking sistem: https://spabooking.preview.emergentagent.com/services
...
6. Proveri u booking sistemu: https://spabooking.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://spabooking.preview.emergentagent.com/api/book-couple-appointment \
