...
- [ ] Promeni API URL u `https://discount-system-fix.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://discount-system-fix.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://discount-system-fix.preview.emergentagent.com/api/book-couple-appointment \
