...
- [ ] Promeni API URL u `https://therapy-booking-21.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://therapy-booking-21.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://therapy-booking-21.preview.emergentagent.com/api/book-couple-appointment \
