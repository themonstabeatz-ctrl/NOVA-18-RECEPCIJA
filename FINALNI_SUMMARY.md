...
- [ ] Promeni API URL u `https://backend-pricing.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://backend-pricing.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://backend-pricing.preview.emergentagent.com/api/book-couple-appointment \
