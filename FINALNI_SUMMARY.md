...
- [ ] Promeni API URL u `https://relax-booking-3.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://relax-booking-3.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://relax-booking-3.preview.emergentagent.com/api/book-couple-appointment \
