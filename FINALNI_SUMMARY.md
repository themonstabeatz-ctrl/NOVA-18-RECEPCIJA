...
- [ ] Promeni API URL u `https://prices-snapshot.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://prices-snapshot.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://prices-snapshot.preview.emergentagent.com/api/book-couple-appointment \
