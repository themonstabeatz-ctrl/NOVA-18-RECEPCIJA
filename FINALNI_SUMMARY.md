...
- [ ] Promeni API URL u `https://massage-scheduler-4.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://massage-scheduler-4.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://massage-scheduler-4.preview.emergentagent.com/api/book-couple-appointment \
