...
- [ ] Promeni API URL u `https://spa-dashboard-2.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://spa-dashboard-2.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://spa-dashboard-2.preview.emergentagent.com/api/book-couple-appointment \
