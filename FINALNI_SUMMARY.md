...
- [ ] Promeni API URL u `https://therapist-scheduler.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://therapist-scheduler.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://therapist-scheduler.preview.emergentagent.com/api/book-couple-appointment \
