...
- [ ] Promeni API URL u `https://massage-booking-fix.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://massage-booking-fix.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://massage-booking-fix.preview.emergentagent.com/api/book-couple-appointment \
