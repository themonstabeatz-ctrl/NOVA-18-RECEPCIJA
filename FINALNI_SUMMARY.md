...
- [ ] Promeni API URL u `https://price-analyzer-8.preview.emergentagent.com/api`
...
6. Proveri u booking sistemu: https://price-analyzer-8.preview.emergentagent.com/appointments
...
**Kompletan test cURL:**
```bash
curl -X POST https://price-analyzer-8.preview.emergentagent.com/api/book-couple-appointment \
