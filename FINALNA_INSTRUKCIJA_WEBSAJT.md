...
**URL:** https://massage-booking-hub.preview.emergentagent.com/

### API ENDPOINT ZA POZIVANJE:
**Base URL:** https://spabooking.preview.emergentagent.com/api
...
// U:
const BOOKING_API = 'https://spabooking.preview.emergentagent.com/api';
```
...
### API Endpoint:
```
POST https://spabooking.preview.emergentagent.com/api/book-couple-appointment
```
...
async function bookCoupleAppointment(formData) {
  ...
  const response = await fetch(
    'https://spabooking.preview.emergentagent.com/api/book-couple-appointment',
    {
      method: 'POST',
