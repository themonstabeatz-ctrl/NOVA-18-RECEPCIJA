...
**URL:** https://spa-dashboard-2.preview.emergentagent.com/

### API ENDPOINT ZA POZIVANJE:
**Base URL:** https://spa-dashboard-2.preview.emergentagent.com/api
...
// U:
const BOOKING_API = 'https://spa-dashboard-2.preview.emergentagent.com/api';
```
...
### API Endpoint:
```
POST https://spa-dashboard-2.preview.emergentagent.com/api/book-couple-appointment
```
...
async function bookCoupleAppointment(formData) {
  ...
  const response = await fetch(
    'https://spa-dashboard-2.preview.emergentagent.com/api/book-couple-appointment',
    {
      method: 'POST',
...
### Test 1: Popusti
1. Otvori booking sistem: https://spa-dashboard-2.preview.emergentagent.com/services
...
1. Idi na: https://spa-dashboard-2.preview.emergentagent.com/
