...
**URL:** https://relax-booking-3.preview.emergentagent.com/

### API ENDPOINT ZA POZIVANJE:
**Base URL:** https://relax-booking-3.preview.emergentagent.com/api
...
// U:
const BOOKING_API = 'https://relax-booking-3.preview.emergentagent.com/api';
```
...
### API Endpoint:
```
POST https://relax-booking-3.preview.emergentagent.com/api/book-couple-appointment
```
...
async function bookCoupleAppointment(formData) {
  ...
  const response = await fetch(
    'https://relax-booking-3.preview.emergentagent.com/api/book-couple-appointment',
    {
      method: 'POST',
...
### Test 1: Popusti
1. Otvori booking sistem: https://relax-booking-3.preview.emergentagent.com/services
