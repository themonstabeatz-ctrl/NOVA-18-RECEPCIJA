...
**Base URL:** https://price-analyzer-8.preview.emergentagent.com/api
...
// U:
const BOOKING_API = 'https://price-analyzer-8.preview.emergentagent.com/api';
```
...
async function bookCoupleAppointment(formData) {
  ...
  const response = await fetch(
    'https://price-analyzer-8.preview.emergentagent.com/api/book-couple-appointment',
    {
      method: 'POST',
...
### Test 1: Popusti
1. Otvori booking sistem: https://price-analyzer-8.preview.emergentagent.com/services
...
1. Idi na: https://price-analyzer-8.preview.emergentagent.com/
