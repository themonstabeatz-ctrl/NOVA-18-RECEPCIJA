...
**URL:** https://massage-scheduler-4.preview.emergentagent.com/

### API ENDPOINT ZA POZIVANJE:
**Base URL:** https://massage-scheduler-4.preview.emergentagent.com/api
...
// U:
const BOOKING_API = 'https://massage-scheduler-4.preview.emergentagent.com/api';
```
...
### API Endpoint:
```
POST https://massage-scheduler-4.preview.emergentagent.com/api/book-couple-appointment
```
...
async function bookCoupleAppointment(formData) {
  ...
  const response = await fetch(
    'https://massage-scheduler-4.preview.emergentagent.com/api/book-couple-appointment',
    {
      method: 'POST',
...
### Test 1: Popusti
1. Otvori booking sistem: https://massage-scheduler-4.preview.emergentagent.com/services
...
1. Idi na: https://massage-scheduler-4.preview.emergentagent.com/
