...
**URL:** https://prices-snapshot.preview.emergentagent.com/

### API ENDPOINT ZA POZIVANJE:
**Base URL:** https://prices-snapshot.preview.emergentagent.com/api
...
// U:
const BOOKING_API = 'https://prices-snapshot.preview.emergentagent.com/api';
```
...
### API Endpoint:
```
POST https://prices-snapshot.preview.emergentagent.com/api/book-couple-appointment
```
...
async function bookCoupleAppointment(formData) {
  ...
  const response = await fetch(
    'https://prices-snapshot.preview.emergentagent.com/api/book-couple-appointment',
    {
      method: 'POST',
...
### Test 1: Popusti
1. Otvori booking sistem: https://prices-snapshot.preview.emergentagent.com/services
