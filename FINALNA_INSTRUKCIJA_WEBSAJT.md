...
**URL:** https://therapy-booking-21.preview.emergentagent.com/

### API ENDPOINT ZA POZIVANJE:
**Base URL:** https://therapy-booking-21.preview.emergentagent.com/api
...
// U:
const BOOKING_API = 'https://therapy-booking-21.preview.emergentagent.com/api';
```
...
### API Endpoint:
```
POST https://therapy-booking-21.preview.emergentagent.com/api/book-couple-appointment
```
...
async function bookCoupleAppointment(formData) {
  ...
  const response = await fetch(
    'https://therapy-booking-21.preview.emergentagent.com/api/book-couple-appointment',
    {
      method: 'POST',
...
### Test 1: Popusti
1. Otvori booking sistem: https://therapy-booking-21.preview.emergentagent.com/services
...
1. Idi na: https://therapy-booking-21.preview.emergentagent.com/
