...
```bash
curl -s "https://discount-fixer.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://couples-discount-fix.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://discount-fixer.preview.emergentagent.com/)
   - Lozinka: studio149
