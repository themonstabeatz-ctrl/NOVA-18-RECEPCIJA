...
```bash
curl -s "https://discount-system-fix.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://discount-system-fix.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://discount-system-fix.preview.emergentagent.com/)
   - Lozinka: studio149
