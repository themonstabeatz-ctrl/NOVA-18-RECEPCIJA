...
```bash
curl -s "https://massage-scheduler-4.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://massage-scheduler-4.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://massage-scheduler-4.preview.emergentagent.com/)
   - Lozinka: studio149
