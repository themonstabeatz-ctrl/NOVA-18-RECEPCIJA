...
```bash
curl -s "https://spa-dashboard-2.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://spa-dashboard-2.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://spa-dashboard-2.preview.emergentagent.com/)
   - Lozinka: studio149
