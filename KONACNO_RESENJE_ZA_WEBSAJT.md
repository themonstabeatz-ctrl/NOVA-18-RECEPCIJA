...
```bash
curl -s "https://spa-web-update.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://spa-web-update.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://spa-web-update.preview.emergentagent.com/)
   - Lozinka: studio149
