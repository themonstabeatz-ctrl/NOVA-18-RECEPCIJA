...
```bash
curl -s "https://spa-booking-api.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://spa-booking-api.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://spa-booking-api.preview.emergentagent.com/)
   - Lozinka: studio149
