...
```bash
curl -s "https://price-consistency.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://price-consistency.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://price-consistency.preview.emergentagent.com/)
   - Lozinka: studio149
