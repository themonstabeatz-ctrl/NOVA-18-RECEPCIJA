...
```bash
curl -s "https://spa-integration.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://spa-integration.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://spa-integration.preview.emergentagent.com/)
   - Lozinka: studio149
