...
```bash
curl -s "https://massage-booking-fix.preview.emergentagent.com/api/services" | \
...
1. Otvori: https://massage-booking-fix.preview.emergentagent.com/massage
...
5. Proveri u Dashboard-u (https://massage-booking-fix.preview.emergentagent.com/)
   - Lozinka: studio149
